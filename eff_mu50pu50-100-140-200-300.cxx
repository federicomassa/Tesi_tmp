...
void eff_all() {
  ...
  TFile* in50 = new TFile("./mu50_pu50-100-140-200-300/hist-mu50pu50.root");
  TFile* in100 = new TFile("./mu50_pu50-100-140-200-300/hist-mu50pu100.root");
  TFile* in140 = new TFile("./mu50_pu50-100-140-200-300/hist-mu50pu140.root");
  TFile* in200 = new TFile("./mu50_pu50-100-140-200-300/hist-mu50pu200.root");
  TFile* in300 = new TFile("./mu50_pu50-100-140-200-300/hist-mu50pu300.root");
  ...
  mg->SetTitle("#sigma(p_{T}) vs |#eta| - Mu 50 GeV; |#eta|; #sigma(p_{T})");
  ...
  mg2->SetTitle("#sigma(D0) vs |#eta| - Mu 50 GeV; |#eta|; #sigma(D0)");
